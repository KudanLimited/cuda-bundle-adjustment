...
file(GLOB DATA_FILES "${_DIR}/module-JBIG-*-data.cmake")
...
if(NOT TARGET JBIG::JBIG)
    ...
    conan_message(STATUS "Conan: Target declared 'JBIG::JBIG'")
else()
    message(WARNING "Target name 'JBIG::JBIG' already exists.")
endif()
# Load the debug and release library finders
get_filename_component(_DIR "${CMAKE_CURRENT_LIST_FILE}" PATH)
file(GLOB CONFIG_FILES "${_DIR}/module-JBIG-Target-*.cmake")
